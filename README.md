...
- [BillingWatch](https://github.com/rmbell09-lang/BillingWatch) - Automated billing anomaly detection for Stripe. Monitors webhook events and alerts on charge failure spikes, duplicate charges, fraud, silent subscription lapses, and revenue drops. ([Source Code](https://github.com/rmbell09-lang/BillingWatch)) `MIT` `Python/Docker`
